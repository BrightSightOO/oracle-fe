...
import { Box, Button, ButtonGroup, HStack, Text, useTheme, VStack } from '@chakra-ui/react';
...
const Stake = () => {
  ...
  const { textPrimary, backgroundCard, textGrey, greyLight, greyLight2, greenBrightSight } =
  ...
  return (
    <VStack w="full" maxW={{ base: 'full', md: '473px' }} alignSelf="start">
      ...
      <HStack w="full" justifyContent="space-between" pb="20px">
        ...
        >
          ...
          <Text textStyle="H6" fontSize={{ base: '10px', xmd: '14px' }} color={greenBrightSight}>
            12.312 OO Staked
          </Text>
        </Box>
      </HStack>
      ...
      <VStack w="full" align="flex-start" pt="80px">
        ...
        <VStack w="full" p="24px" bg={backgroundCard} borderRadius="lg">
          ...
          <VStack w="full">
            {unlocks.map((unlock) => (
              <HStack key={unlock.amount + unlock.date} w="full" justifyContent="space-between">
